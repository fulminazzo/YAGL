...
public class ItemParticleOptionParser extends YAMLParser<ItemParticleOption<?>> {
    ...
    @Override
    protected @NotNull BiFunctionException<IConfiguration, String, ItemParticleOption<?>, Exception> getLoader() {
        return (c, s) -> {
            AbstractItem item = c.get(s, ReflectionUtils.getClass("it.fulminazzo.yagl.item.Item"));
    ...
    @Override
    protected @NotNull TriConsumer<IConfiguration, String, ItemParticleOption<?>> getDumper() {
